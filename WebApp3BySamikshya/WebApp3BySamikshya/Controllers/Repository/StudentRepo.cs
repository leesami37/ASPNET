...
using WebApp3BySamikshya.Models;

namespace WebApp3BySamikshya.Controllers.Repository
{
    public class StudentRepo
    {
        ...
        public List<Student> GetAllRecord()
        {
            ...
            try
            {
                ...
                //string conStr = @"server=DESKTOP-JAE0FTL\MSSQLSERVER01; database=Samikshya; Trusted_Connection=True; TrustServerCertificate=True;";
                string conStr = @"server=DESKTOP-5PA6O0N\SQLEXPRESS; database=Samikshya; Trusted_Connection=True; TrustServerCertificate=True;";
        ...
        public void DeleteStudent(int id)
        {
            ...
            {
                // Write user name from SSMS software
                //string conStr = @"server=DESKTOP-5PA6O0N\SQLEXPRESS; database=GiverDB; Trusted_Connection=True; TrustServerCertificate=True;";
                string conStr = @"server=DESKTOP-5PA6O0N\SQLEXPRESS; database=Samikshya; Trusted_Connection=True; TrustServerCertificate=True;";
                SqlConnection conn = new SqlConnection(conStr);
                conn.Open();
                Console.WriteLine("Connection Established");
